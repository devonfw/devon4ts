...
interface IMailerModuleOptions {
    ...
    mailOptions?: nodemailer.TransportOptions | SESTransport.Options | JSONTransport.Options | StreamTransport.Options | SendmailTransport.Options | SMTPPool.Options | SMTPTransport.Options | string;
    emailFrom: string;
}
