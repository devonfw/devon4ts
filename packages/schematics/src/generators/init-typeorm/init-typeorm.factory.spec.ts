...
`;
  ...
  it('should do nothing if not running at root folder', done => {
    runner.runSchematic('typeorm', { db: 'mysql' }).then(tree => {
  ...
  it('should generate all files if it is running at root folder', async () => {
    ...
    tree = await runner.runSchematic('typeorm', { db: 'mysql' }, tree).then();
  ...
  describe('cockroachdb', () => {
    it('should configure the datasource for cockroachdb', async () => {
      let tree = await runner.runSchematic('application', { name: '' }).then();
      tree = await runner.runSchematic('typeorm', { db: 'cockroachdb' }, tree).then();
  ...
  describe('mariadb', () => {
    it('should configure the datasource for mariadb', async () => {
      let tree = await runner.runSchematic('application', { name: '' }).then();
      tree = await runner.runSchematic('typeorm', { db: 'mariadb' }, tree).then();
  ...
  describe('sqlite', () => {
    it('should configure the datasource for sqlite', async () => {
      let tree = await runner.runSchematic('application', { name: '' }).then();
      tree = await runner.runSchematic('typeorm', { db: 'sqlite' }, tree).then();
  ...
  describe('oracle', () => {
    it('should configure the datasource for oracle', async () => {
      let tree = await runner.runSchematic('application', { name: '' }).then();
      tree = await runner.runSchematic('typeorm', { db: 'oracle' }, tree).then();
  ...
  describe('mssql', () => {
    it('should configure the datasource for mssql', async () => {
      let tree = await runner.runSchematic('application', { name: '' }).then();
      tree = await runner.runSchematic('typeorm', { db: 'mssql' }, tree).then();
  ...
  describe('mongodb', () => {
    it('should configure the datasource for mongodb', async () => {
      let tree = await runner.runSchematic('application', { name: '' }).then();
      tree = await runner.runSchematic('typeorm', { db: 'mongodb' }, tree).then();
